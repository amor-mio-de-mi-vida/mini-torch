...
class Sigmoid(Function):
    ...
    def backward(ctx: Context, grad_output: Tensor) -> Tensor:
        # TODO: Implement for Task 2.4.
        (tmp,) = ctx.saved_values
        func = grad_output.f
        return func.mul_zip(grad_output, func.mul_zip(tmp, func.add_zip(tensor([1.0]), func.neg_map(tmp))))
        # raise NotImplementedError('Need to implement for Task 2.4')
...
class ReLU(Function):
    ...
    def backward(ctx: Context, grad_output: Tensor) -> Tensor:
        # TODO: Implement for Task 2.4.
        (tmp,) = ctx.saved_values
        return grad_output.f.relu_back_zip(tmp, grad_output)
        # raise NotImplementedError('Need to implement for Task 2.4')
...
class Log(Function):
    ...
    def backward(ctx: Context, grad_output: Tensor) -> Tensor:
        # TODO: Implement for Task 2.4.
        (tmp,) = ctx.saved_values
        return grad_output.f.log_back_zip(tmp, grad_output)
        # raise NotImplementedError('Need to implement for Task 2.4')
...
class Exp(Function):
    ...
    def backward(ctx: Context, grad_output: Tensor) -> Tensor:
        # TODO: Implement for Task 2.4.
        (tmp,) = ctx.saved_values
        return grad_output.f.exp_map(tmp, grad_output)
        # raise NotImplementedError('Need to implement for Task 2.4')
